...
import tga.folder_sync.master_worker.AbstractSequienceMasterActor
...
) : AbstractSequienceMasterActor<SyncCmd>(numberOfWorkers, SyncWorkerActor::class, requesterActor, syncCmdsSequence) {
